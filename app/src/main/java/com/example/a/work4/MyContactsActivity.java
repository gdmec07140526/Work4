...
public class MyContactsActivity extends Activity {
    ...
    public void importPhone(String name,String phone){
        ...
        Uri rawContcntUri = this.getContentResolver().insert(ContactsContract.RawContacts.CONTENT_URI,values);
        long rawContactId = ContentUris.parseId(rawContcntUri);
        values.clear();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case 1:
                Intent intent = new Intent(MyContactsActivity.this,
            ...
            case 6:
                if (users[selectItem].getId_DB()>0){
                    ...
                    Toast.makeText(this,"已结成功导入"+users[selectItem].getName()+"到手机电话簿！",Toast.LENGTH_SHORT).show();
                }else {
                    Toast.makeText(this,"无结果记录，无法操作！",Toast.LENGTH_SHORT).show();
                }
                break;
